            ...
            return (
              <Link
                ...
                style={{
                  ...
                  borderColor: active ? '#fecdd3' : 'transparent',
...
const styles = {
  ...
  brandDot: {
    ...
    borderRadius: '50%',
    background: '#e11d48',
    boxShadow: '0 0 0 6px rgba(225, 29, 72, 0.12)',
  },
  brandTitle: { fontWeight: 700, color: '#111111' },
  ...
  userName: { fontSize: 13, fontWeight: 600, color: '#111111' },
